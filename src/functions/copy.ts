...
type CopyArgs = [array: NDArray, options?: NDArrayCopyOptions];

function generateCopyCode(dimensions: number): string {
  return `
    options = options || {};
...
const copy = createCachedCompiledFunction<number, CopyArgs, NDArray>(
